...
public class googlyRock{
	...
	public googlyRock() {
		forward 	= getImage("/imgs/"+"googlyRock.png"); //load the image for Tree
		...
		*/
		//alter these
		width = (int)(66*scaleWidth);
		height = (int)(60*scaleHeight);
		x = 300;
		y = 10;
		vx = 0;
		vy = 0;
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = googlyRock.class.getResource(path);
